...
function quizQuestion() {
	...
	if (selectedOption1 == 'a') {
		...
		document.getElementById('ans1').innerHTML = "INCORRECT: the correct answer is A) Dr. G. D. Bist"
	}
	...
	if (selectedOption2 == 'b') {
		...
		document.getElementById('ans2').innerHTML = "INCORRECT: the correct answer is B) Nazi party"
	}
	...
	if (selectedOption3 == 'b') {
		...
		document.getElementById('ans3').innerHTML = "INCORRECT: the correct answer is B) 1940"
	}
